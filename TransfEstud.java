 ...
 * @author crist
 */
public class TransfEstud extends JFrame{
    private JTextArea area;
    private JLabel label;
    private JButton boton;
    private JTextField texto, texto1;
    public static int numerous;
    
    public TransfEstud(){
    super("Transferencia de Saldo Entre Estudiantes");
    ...
    public void transferir(String nombre, int monto){
        ...
        for(int i = 0; i <= 9; i++){
        if(nombre.equals(Inicio.usuarions[i])){
        int guardar;
        int mi;
        int suma, resta;
        guardar = SaldoInicial.Saldo[i];
        suma = monto + guardar;
        SaldoInicial.Saldo[i] = suma;
    ...
    public void vitacora(String vi){
